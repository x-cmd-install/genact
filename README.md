...
Total: **3,299** lines of code across **34** files in the top 5 languages.
...
- **Upstream**: <https://github.com/svenstaro/genact>
...
- **Stars**: 12,189 · **Forks**: 496 · **Open issues**: 67 · **Contributors**: 34

## Totals (cumulative)

- **Releases**: 27 · **Merged PRs**: 358 · **Open PRs**: 4 · **Closed issues**: 55 · **Open issues**: 12 · **Commits**: 1182
...
Reported by **19** distros on [repology.org](https://repology.org/project/genact). **15** are ✅ on the latest upstream release, **4** are ⚠️ on an older version.
...
_Snapshot: `data/card/260912.yml` · 2026-09-12T04:55:49Z._
